...
values ('mariuszo', 'mariuszo8@vp.pl','{bcrypt}$2a$10$K9bRFxj3dvfQFQQ6hl.wuua.FRiOQhZNKbn3tvC2Od6c8kvohEp7e', 2, 1, true, 1);
insert into users (username, email, password, user_role_id, user_info_id, is_enabled, cart_id)
values ('admin', 'kontakt@mowebcreations.pl','{bcrypt}$2a$10$K9bRFxj3dvfQFQQ6hl.wuua.FRiOQhZNKbn3tvC2Od6c8kvohEp7e', 1, 2, true, 2);
